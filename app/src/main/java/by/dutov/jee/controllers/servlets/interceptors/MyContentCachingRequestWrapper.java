...
public class MyContentCachingRequestWrapper extends HttpServletRequestWrapper {
	 ...
	 */
	public MyContentCachingRequestWrapper(HttpServletRequest request, int contentCacheLimit) throws IOException {
		super(request);
	 ...
	 * @see #MyContentCachingRequestWrapper(HttpServletRequest, int)
	 */
